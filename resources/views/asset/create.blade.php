        ...
        <div class="card-body">
            <form method="post" action="{{ url('/assets') }}">
                ...
                <div class="form-group">
                    <label for="game">Nama Barang</label>
                ...
                <div class="form-group">
                    <label for="identifier">Nama Toko</label>
                ...
                <div class="form-group">
                    <label for="genre">Rasa</label>
                    <select name="genre[]" id="genre" class="genres @error('genre') is-invalid @enderror" multiple=" multiple" data-placeholder="Pilih Rasa" data-dropdown-css-class="select2-purple" style="width: 100%;">
                        @php
